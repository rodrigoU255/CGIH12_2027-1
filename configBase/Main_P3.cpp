...
void createFigure(glm::mat4 model , GLint modelLoc, glm::vec3 position, float degree,glm::vec3 rotation, glm::vec3 scale) {
	model = glm::mat4(1);
...
int main() {
 ...
 //     
	...
	glm::mat4 projection=glm::mat4(1); //Declaracion e inicializacion de matriz
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model = glm::mat4(1);
		//model = glm::translate(model, glm::vec3(2.0f, 2.0f, 0.0f));
		//model = glm::rotate(model, -10.0f, glm::vec3(1.0f, 0.0f, 1.0f));
		...
		//model = glm::scale(model, glm::vec3(0.1f, 1.0f, 6.0f));
